...
class ListUsersResponse(object):
    ...
    def __init__(self, href=None, values=None, failed=None, links=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type values: dict[str, finbourne_insights.UserSummary]
        :param failed:  Failed entities, indexed by their id
        :type failed: dict[str, finbourne_insights.ErrorDetail]
        :param links: 
    ...
    def values(self):
        ...
        :rtype: dict[str, finbourne_insights.UserSummary]
        """
        return self._values
    ...
    def failed(self):
        ...
        :rtype: dict[str, finbourne_insights.ErrorDetail]
        """
        return self._failed
